...
//    // clion:
//    const std::string& modelPath = "last.onnx"; // pose
//
...
//    float mask_threshold = 0.2f;  // in python it's 0.5 and you can see that at ultralytics/utils/ops.process_mask line 705 (ultralytics.__version__ == .160)
